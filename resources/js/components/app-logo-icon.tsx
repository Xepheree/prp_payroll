...
export default function AppLogoIcon(props: SVGAttributes<SVGSVGElement>) {
    return (
        ...
        >
            <path
                d="M88.7,40.6c5.1,0,9.3,4,9.7,9l1.2,18.5l12.3,7.4l0,31.3h-5.5l0,10.2c0,4.4-3.6,8-8,8c-4.4,0-8-3.5-8-8v-10.2H37.4l0,10.2
            ...
            <path
                d="M103.2,5c4.9,0,8.8,3.9,8.8,8.8v56.7l-8.1-5L102.8,49
                c-0.7-7.1-6.8-12.7-14.1-12.7H39.3c-7.4,0-13.4,5.6-14.1,12.7
